...
const ContenidoGps = (props) => {
  ...
  return (
    <div className="benefit-item card backcolor" >
       <i className="bi bi-info-circle negrita " style={{ color: "#F0BA2D" }}> Por favor, ten en cuenta que al querer utilizar la aplicación GPS, es necesario activar la función de ubicación en tu dispositivo. <br />
